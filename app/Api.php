...
class Api
{
	...
	public function toArray(array $result)
	{
	...
	public function response($code = 200): void
	{
		...
		$tab = json_encode(array('tété'));
		
		$t = json_encode(array_merge($this->result, $this->newToken) + array('error' => 0), JSON_UNESCAPED_UNICODE);
	...
	public static function error(string $data): void
	{
		...
		if ($_SERVER['HTTP_HOST'] == '127.0.0.1' || DEBUG_PROD) {
			$message = $data;
		}
